...
public class PlateBlockBlockEntity extends BlockEntity implements MenuProvider, Nameable {
    ...
    public static void setMenuFactory(MenuFactory factory) {
        menuFactory = Objects.requireNonNull(factory);
    }

    private static MenuFactory getMenuFactory() {
        if (menuFactory == null) {
            throw new IllegalStateException(
                    "Plate menu factory has not been initialized"
            );
        }
    ...
    public PlateBlockBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(DinnerwareBlockEntities.plateBlockEntityType(), pPos, pBlockState);
    ...
    public @Nullable AbstractContainerMenu createMenu(int pContainerId, @NotNull Inventory pPlayerInventory, @NotNull Player pPlayer) {
        return getMenuFactory().create(pContainerId, pPlayerInventory, this, this.containerData);
    }

    protected AbstractContainerMenu createMenu(int pContainerId, Inventory pInventory) {
        return getMenuFactory().create(pContainerId, pInventory, this, this.containerData);
    }
    ...
    protected void saveClientData(CompoundTag pTag) {
        if (pTag == null)
    ...
    protected void loadClientData(CompoundTag pTag) {
        if (pTag != null) {
